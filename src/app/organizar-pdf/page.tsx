...
export default function OrganizePdfPage() {
    ...
    const { loadPdfPages, isLoading } = usePdfMultiLoader(); // ✨ USAR HOOK
    ...
    const handleAddBlankPage = () => {
        ...
        setPages(prev => {
            if (selectedIds.length === 1) {
                const index = prev.findIndex(p => p.id === selectedIds[0]);
                if (index !== -1) {
                    const newArr = [...prev];
        ...
        setPages(prev => {
            return prev.flatMap(p => {
                if (selectedIds.includes(p.id)) {
                    return [p, { ...p, id: crypto.randomUUID() }];
                }
                return [p];
            });
        });
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            ...
                            <Tooltip>
                                ...
                                <TooltipContent>
                                    <p>Inserta una página en blanco</p>
                                </TooltipContent>
                            </Tooltip>
                            ...
                            <Tooltip>
                                ...
                                <TooltipContent>Clona las páginas seleccionadas</TooltipContent>
                            </Tooltip>
