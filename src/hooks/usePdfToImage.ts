/**
 * Hook para convertir PDF a Imágenes
 * Refactorizado: Lógica compleja extraída a lib/pdf-to-image-utils.ts
 */
...
export type { ProcessingMode, FormatInfo };

// Re-exports for compatibility
export { shouldUseServer, getFormatInfo } from "@/lib/pdf-to-image-utils";
