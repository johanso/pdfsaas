...
export function Dropzone({
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isDragging
          ...
          : "dark:border-zinc-800 bg-zinc-100 hover:bg-zinc-200/40 border-zinc-200 hover:border-zinc-300 dark:bg-zinc-900/50  dark:hover:bg-zinc-800/50 dark:hover:border-zinc-700 transition-all",
    ...
    >
      ...
      <div className={cn(
        "p-4 rounded-full mb-6 border border-zinc-200",
