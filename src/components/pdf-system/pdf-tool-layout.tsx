...
import { PasswordProtectedState } from "./password-protected-state";
          ...
          {!hasFiles ? (
            ...
            <div className="space-y-2">
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                <div className={cn(
                  "space-y-2 relative",
                  hasPasswordError ? "lg:col-span-4" : "lg:col-span-3"
                )}>
                  <ToolBreadcrumb toolId={toolId} />
                  {headerContent && (
                  ...
                  {isMobile && !hasPasswordError && (
                    <PdfToolbar onReset={onReset} textAdd={textAdd} />
                  )}
                  {!isMobile && hasFeatures && !hasPasswordError && (
                  ...
                  <section className={cn(
                    ...
                    layout === "grid"
                      ? `${hasPasswordError ? "" : "bg-zinc-200/30 dark:bg-zinc-700/20"} p-4`
